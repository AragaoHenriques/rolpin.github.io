...
(function ($) {
	...
	jQuery(document).ready(function($) {
		...
		$('#rbRoloAngora').click(function() {
			...
			document.getElementById('rbRoloAngora').style.fontSize = '1.2em';
			...
			document.getElementById("ul1li1tr1td2").innerText = 'Rolo Angora';
			...
			document.getElementById("ul1li1tr2td2").innerText = 'Rolo Angora';
			...
			document.getElementById("ul1li1tr3td2").innerText = 'Rolo Angora';
			...
			document.getElementById("ul1li1tr4td2").innerText = 'Rolo Angora';
			...
			document.getElementById("ul1li1tr5td2").innerText = 'Rolo Angora';
			document.getElementById("ul1li1tr5td3").innerText = '250';
			document.getElementById("ul1li1tr5td4").innerText = '45';
			
			document.getElementById("ul1li1tr6td1").innerText = '01CA60';
			document.getElementById("ul1li1tr6td2").innerText = 'Carga Angora';
			document.getElementById("ul1li1tr6td3").innerText = '60';
			document.getElementById("ul1li1tr6td4").innerText = '45';
			document.getElementById("ul1li1tr7td1").innerText = '01CA150';
			document.getElementById("ul1li1tr7td2").innerText = 'Carga Angora';
			document.getElementById("ul1li1tr7td3").innerText = '150';
			document.getElementById("ul1li1tr7td4").innerText = '45';
			document.getElementById("ul1li1tr8td1").innerText = '01CA180';
			document.getElementById("ul1li1tr8td2").innerText = 'Carga Angora';
			document.getElementById("ul1li1tr8td3").innerText = '180';
			document.getElementById("ul1li1tr8td4").innerText = '45';
			document.getElementById("ul1li1tr9td1").innerText = '01CA220';
			document.getElementById("ul1li1tr9td2").innerText = 'Carga Angora';
			document.getElementById("ul1li1tr9td3").innerText = '220';
			document.getElementById("ul1li1tr9td4").innerText = '45';
			document.getElementById("ul1li1tr10td1").innerText = '01CA250';
			document.getElementById("ul1li1tr10td2").innerText = 'Carga Angora';
			document.getElementById("ul1li1tr10td3").innerText = '250';
			document.getElementById("ul1li1tr10td4").innerText = '45';
		...
		$('#rbMiniRoloAngora').click(function() {
			...
			document.getElementById('rbMiniRoloAngora').style.fontSize = '1.2em';
			...
			document.getElementById("ul1li1tr1td2").innerText = 'Mini Rolo Angora';
			document.getElementById("ul1li1tr1td3").innerText = '60';
			document.getElementById("ul1li1tr1td4").innerText = '16';
			document.getElementById("ul1li1tr2td1").innerText = '01MRANGC10';
			document.getElementById("ul1li1tr2td2").innerText = 'Mini Rolo Angora';
			...
			document.getElementById("ul1li1tr3td2").innerText = 'Mini Rolo Angora (Armação Longa)';
			document.getElementById("ul1li1tr3td3").innerText = '100';
			document.getElementById("ul1li1tr3td4").innerText = '16';
			document.getElementById("ul1li1tr4td1").innerText = '01CIANG6';
			document.getElementById("ul1li1tr4td2").innerText = 'Carga Rolo Angora';
			document.getElementById("ul1li1tr4td3").innerText = '60';
			document.getElementById("ul1li1tr4td4").innerText = '16';
			document.getElementById("ul1li1tr5td1").innerText = '01CIANG';
			document.getElementById("ul1li1tr5td2").innerText = 'Carga Rolo Angora';
			document.getElementById("ul1li1tr5td3").innerText = '100';
			document.getElementById("ul1li1tr5td4").innerText = '16';
			document.getElementById("ul1li1tr6td1").innerText = '01CIANG16';
			document.getElementById("ul1li1tr6td2").innerText = 'Carga Rolo Angora';
			document.getElementById("ul1li1tr6td3").innerText = '160';
			document.getElementById("ul1li1tr6td4").innerText = '16';
			document.getElementById("ul1li1tr7td1").innerText = '012CMRA6';
			document.getElementById("ul1li1tr7td2").innerText = '2 Cargas Mini Rolo Angora';
			document.getElementById("ul1li1tr7td3").innerText = '60';
			document.getElementById("ul1li1tr7td4").innerText = '16';
			document.getElementById("ul1li1tr8td1").innerText = '012CMRA11';
			document.getElementById("ul1li1tr8td2").innerText = '2 Cargas Mini Rolo Angora';
			document.getElementById("ul1li1tr8td3").innerText = '100';
			document.getElementById("ul1li1tr8td4").innerText = '16';
			document.getElementById("ul1li1tr9td1").innerText = '012CMRA16';
			document.getElementById("ul1li1tr9td2").innerText = '2 Cargas Mini Rolo Angora';
			document.getElementById("ul1li1tr9td3").innerText = '150';
			document.getElementById("ul1li1tr9td4").innerText = '16';
			document.getElementById("ul1li1tr10td1").innerText = '01CXANG';
			document.getElementById("ul1li1tr10td2").innerText = 'Blister 10 unidades';
			document.getElementById("ul1li1tr10td3").innerText = '100';
			document.getElementById("ul1li1tr10td4").innerText = '16';
			document.getElementById("ul1li1tr11td1").innerText = '01CMDRA12';
			document.getElementById("ul1li1tr11td2").innerText = 'Mini Rolo';
			document.getElementById("ul1li1tr11td3").innerText = '120';
			document.getElementById("ul1li1tr11td4").innerText = '30';
			document.getElementById("ul1li1tr12td1").innerText = '01CMDRA15';
			document.getElementById("ul1li1tr12td2").innerText = 'Mini Rolo';
			document.getElementById("ul1li1tr12td3").innerText = '150';
			document.getElementById("ul1li1tr12td4").innerText = '30';
			document.getElementById("ul1li1tr13td1").innerText = '012CMDRA12';
			document.getElementById("ul1li1tr13td2").innerText = 'Pack 2 Unidades';
			document.getElementById("ul1li1tr13td3").innerText = '120';
			document.getElementById("ul1li1tr13td4").innerText = '30';
			document.getElementById("ul1li1tr14td1").innerText = '012CMDRA15';
			document.getElementById("ul1li1tr14td2").innerText = 'Pack 2 Unidades';
			document.getElementById("ul1li1tr14td3").innerText = '150';
			document.getElementById("ul1li1tr14td4").innerText = '30';
